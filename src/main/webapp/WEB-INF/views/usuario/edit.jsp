...
<head>
    ...
    <title>Editar Usuário - E-commerce</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="header">
        ...
        <p>Modificar dados do usuário</p>
    </div>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h2>Editar Usuário - ${usuario.nomeCompleto}</h2>
                ...
                <form method="post" action="usuario">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="primeiroNome" name="primeiroNome" 
                                   value="${usuario.primeiroNome}" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="cpf" name="cpf" 
                               value="${usuario.cpf}" maxlength="11" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="senhaHash" name="senhaHash" 
                               value="${usuario.senhaHash}" required>
