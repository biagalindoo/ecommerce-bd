...
<head>
    ...
    <title>Editar Produto - E-commerce</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="header">
        ...
        <p>Modificar dados do produto</p>
    </div>
            ...
            <div class="card-body">
                ...
                <form method="post" action="produto">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="descricao" name="descricao" placeholder="Descrição detalhada do produto...">${produto.descricao}</textarea>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="quantidadeEstoque" name="quantidadeEstoque" min="0" 
                                   value="${produto.quantidadeEstoque}" required>
                    ...
                    <div class="form-group">
                        ...
                        <select id="armazemId" name="armazemId" required>
                            ...
                            <c:forEach var="armazem" items="${armazens}">
                                <c:set var="armazemId" value="${armazem.split(' - ')[0]}"/>
                                <c:set var="armazemNome" value="${armazem.split(' - ')[1]}"/>
                                <option value="${armazemId}" ${armazemId == produto.armazemId ? 'selected' : ''}>
                                    ${armazem}
                                </option>
                            </c:forEach>
                        </select>
